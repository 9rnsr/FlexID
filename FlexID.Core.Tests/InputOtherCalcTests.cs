...
public class InputOtherCalcTests
{
    ...
    public void TestAdjustIncorrectMarrow()
    {
        ...
        [
            "(12): Both of C/T-marrow and R/Y-marrow source region pairs are used for nuclide 'Th-232'.",
            "(12):     acc  C-marrow  C-marrow",
            "(13):     acc  T-marrow  T-marrow",
            "(14):     acc  R-marrow  R-marrow",
            "(15):     acc  Y-marrow  Y-marrow",
        ]);
    }
}
