...
namespace FlexID.Calc.Tests
{
    public class InputReadTests
    {
        ...
        [InlineData("Mo-93_ing-Other")]
        [InlineData("Mo-93_ing-Sulphide")]
        [InlineData("Mo-93_inh-TypeF")]
        [InlineData("Mo-93_inh-TypeM")]
        [InlineData("Mo-93_inh-TypeS")]
        [InlineData("Pu-238_ing-Insoluble")]
        [InlineData("Pu-238_ing-Soluble")]
        [InlineData("Pu-238_inh-TypeF")]
        [InlineData("Pu-238_inh-TypeM")]
        [InlineData("Pu-238_inh-TypeS")]
        [InlineData("Pu-239_ing-Insoluble")]
        [InlineData("Pu-239_ing-Soluble")]
