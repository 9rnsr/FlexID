...
namespace FlexID.Calc
{
    ...
    // {
    //     public Expr Identifier(string ident) => new VarExpr(ident);
    ...
    public class InputEvaluator : Visitor<(decimal v, bool r)>
    {
        ...
        public bool TryReadVarDecl(int lineNum, string nextLine)
        {
            ...
            var result = parser.VarDecl.Token().End().TryParse(nextLine);
