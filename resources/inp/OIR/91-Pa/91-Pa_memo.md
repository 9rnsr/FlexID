...
|C-marrow   *1 |C-marrow |C-marrow |C-marrow |C-marrow      |      |      |      |C-marrow *1|C-marrow *1|C-marrow   *1 |C-marrow *1|
|T-marrow   *1 |T-marrow |T-marrow |T-marrow |T-marrow      |      |      |      |T-marrow *1|T-marrow *1|T-marrow   *1 |T-marrow *1|
...
|Testes     *1 |Testes   |Testes   |Testes   |Testes        |      |      |      |Testes     |Testes   *1|Testes     *1 |Testes   *1|
|Ovaries    *1 |Ovaries  |Ovaries  |Ovaries  |Ovaries       |      |      |      |Ovaries    |Ovaries  *1|Ovaries    *1 |Ovaries  *1|
|Skin       *1 |Skin   *1|Skin   *1|Skin   *1|Skin          |      |      |      |Skin       |Skin     *1|Skin       *1 |Skin     *1|
|Spleen     *1 |Spleen *1|Spleen *1|Spleen *1|Spleen        |      |      |      |Spleen     |Spleen   *1|Spleen     *1 |Spleen   *1|
...
ICRP Publ.141 p.253 Para.614
> (614) The treatment of radioactive progeny of protactinium produced in systemic
...
> (614) 全身の区画内で生成された、あるいは呼吸器や消化管での生成後に血液中に吸収された
> プロトアクチニウムの放射性娘核種の取り扱いについては、18.2.4節に記載されている。
