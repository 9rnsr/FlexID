...
```
18.2.10. Treatment of radioactive progeny
...
actinide progeny is the model applied to uranium as a progeny of thorium [also
described in OIR Part 3 (ICRP, 2017)].
（562）ここでタリウム、鉛、ビスマス、ポロニウム、ラジウムに適用されるモデルは、
アクチニドの娘元素としてこれらの元素に適用されるモデルと同じである。
[OIR Part 3（ICRP、2017）に記載]。ここでウランに適用されるモデルは、
アクチニドの娘元素としてウランに適用されるモデルと同じである。
[これもOIR Part 3（ICRP、2017）に記載]。
